...
def visit_ibmbraceorjp(
    ...
    element = driver.find_element(By.ID, "commonHead")
    ibmbraceorjp_url_path = element.get_attribute("onclick").split("'")[1]
    url = f"{BOATRACEJP_MAIN_URL}{ibmbraceorjp_url_path}"
